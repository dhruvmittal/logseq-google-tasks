...
### 2. Minimal UI
- **Removed React UI:** Simplified application by removing original UI elements. 
- **One-Click Sync:** Clicking the toolbar icon triggers an immediate background sync.
...
- **Pair with [Tidy Blocks](https://github.com/vyleung/logseq-tidy-blocks-plugin)** to tuck the properties blocks away for reference.  
